...
/* 名簿参照 */
  ...
  classfilter: "",
  studentList: [
    { class: "A", number: 1, name: "伊藤 真悠子", join: true },
    { class: "A", number: 2, name: "岡田 美穂", join: false },
    { class: "A", number: 3, name: "加藤 太一", join: true },
    { class: "A", number: 4, name: "佐々木 翔太", join: true },
    { class: "A", number: 5, name: "高橋 朋子", join: false },
    { class: "A", number: 6, name: "中野 健一", join: false },
    { class: "A", number: 7, name: "藤本 さやか", join: true },
    { class: "A", number: 8, name: "松田 聡太", join: true },
    { class: "A", number: 9, name: "山口 未来", join: true },
    { class: "A", number: 10, name: "渡辺 雄大", join: true },
    { class: "B", number: 1, name: "井上 華子", join: false },
    { class: "B", number: 2, name: "川村 雄太", join: false },
    { class: "B", number: 3, name: "小林 真理", join: false },
    { class: "B", number: 4, name: "佐藤 健太", join: true },
    { class: "B", number: 5, name: "鈴木 美佳", join: true },
    { class: "B", number: 6, name: "高田 聡一", join: true },
    { class: "B", number: 7, name: "中島 美和", join: true },
    { class: "B", number: 8, name: "林 裕太", join: true },
    { class: "B", number: 9, name: "三浦 美咲", join: true },
    { class: "B", number: 10, name: "山田 貴之", join: true },
    { class: "C", number: 1, name: "大野 健太", join: true },
    { class: "C", number: 2, name: "川崎 大輔", join: false },
    { class: "C", number: 3, name: "木村 美咲", join: true },
    { class: "C", number: 4, name: "佐藤 美和", join: false },
    { class: "C", number: 5, name: "高橋 聡一", join: false },
    { class: "C", number: 6, name: "中島 さやか", join: false },
    { class: "C", number: 7, name: "林 裕太", join: false },
    { class: "C", number: 8, name: "松田 真悠", join: true },
    { class: "C", number: 9, name: "安田 真悠子", join: true },
    { class: "C", number: 10, name: "吉田 貴之", join: false },
    { class: "D", number: 1, name: "石井 さゆり", join: true },
    { class: "D", number: 2, name: "岡田 美穂", join: true },
    { class: "D", number: 3, name: "加藤 大樹", join: true },
    { class: "D", number: 4, name: "佐藤 勇太", join: false },
    { class: "D", number: 5, name: "高木 聖美", join: true },
    { class: "D", number: 6, name: "中西 健太郎", join: true },
    { class: "D", number: 7, name: "藤田 真悠", join: true },
    { class: "D", number: 8, name: "松本 翔太", join: false },
    { class: "D", number: 9, name: "山口 美咲", join: true },
    { class: "D", number: 10, name: "渡部 大輔", join: true },
  ],
